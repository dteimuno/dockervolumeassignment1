...
docker container run -d --name psql1 -v $(pwd):/var/lib/postgresql/data postgres:9.6.1
...
docker container run -d --name psql2 -v $(pwd):/var/lib/postgresql/data postgres:9.6.2
